...
<html lang="en">
    ...
    <body>
        ...
        <div id="preload-cover-background-container" style="background-image:url(images/smaller/<?php echo $backgroundImage; ?>);-webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;"></div>
    </body>
</html>
